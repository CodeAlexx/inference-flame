...
| Qwen-Image-Edit-2511 | Same 60-layer DiT as 2512 + multi-region RoPE | Pipeline runs end-to-end (1024², 50 steps, BlockOffloader, ~25 min) but **edit quality is not production**: composition is preserved, the prompt-driven edit currently does not land cleanly. Investigation ongoing. |
